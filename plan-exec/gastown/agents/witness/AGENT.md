...
2. Monitor worker health and report anomalies to the Deacon
3. Handle local state persistence for transient workers
4. Facilitate handoffs between workers on the same rig
5. Clean up after completed or failed sessions
6. Report rig-level metrics to the Mayor when asked
```
